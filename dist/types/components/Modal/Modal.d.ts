...
export declare function Modal({ open, onClose, title, description, showClose, primaryAction, secondaryAction, footerLeft, children, className, }: ModalProps): import("react/jsx-runtime").JSX.Element | null;
